...
local Success, Response = pcall(function()
	Icons = HttpService:JSONDecode(game:HttpGetAsync("https://raw.githubusercontent.com/xSTronG30/Roblox-Scripts-Menu/main/espGui-icons.lua")).icons
end)
...
function OrionLib:MakeWindow(WindowConfig)
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		OrionLib:MakeNotification({
			...
			Content = "Tap Left Alt to reopen the interface",
			Time = 5
		})
	...
	AddConnection(UserInputService.InputBegan, function(Input)
		if Input.KeyCode == Enum.KeyCode.LeftAlt and UIHidden == false then
			MainWindow.Visible = false
			UIHidden = true
		elseif Input.KeyCode == Enum.KeyCode.LeftAlt and UIHidden == true then
